...
public class BuildHtmlSample {
	...
	public static void main(String[] args) {
		...
		//-------------------------
		// Wikimeta Extractor
		result = wikimetaAPICaller.getResult( SemkitConfiguration.APIRestURi, SemkitConfiguration.APIAccount , wikimetaAPICaller.Format.XML, toannotate , ln);
		// Wikimeta decoder
		AnnotationInterface annotations = new WikimetaXMLDecoder();
//		annotations.decoder(result, toannotate, 3);
