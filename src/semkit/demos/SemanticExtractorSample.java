...
public class SemanticExtractorSample {
	...
	public static void main(String[] args) throws JSONException {
		...
		// collect the configuration informations, use by default the Wikimeta configuration
		// replace WMRestUri and WMAPIAccount if you want to use Aida.
		...
		String result = wikimetaAPICaller.getResult( SemkitConfiguration.APIRestURi, apikey, wikimetaAPICaller.Format.JSON, toAnnotate , "FR");
		System.out.println( toAnnotate);
