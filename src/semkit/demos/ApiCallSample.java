...
import semkit.annotatedobjects.WikimetaJSONDecoder;
...
public class ApiCallSample {
	...
	public static void main(String[] args) throws JSONException {
		...
		String apikey = SemkitConfiguration.APIAccount; // define your API key here or in config or SemanticConstants file - by default, we use wikimeta 
		 ...
		 */
		if ( command == 0) {
				result = wikimetaAPICaller.getResult( SemkitConfiguration.APIRestURi, apikey, wikimetaAPICaller.Format.JSON, toannotate , ln);
		 ...
		 */
		if ( command == 1) {
			result = wikimetaAPICaller.getResultFullCall( SemkitConfiguration.APIRestURi, apikey, wikimetaAPICaller.Format.JSON, ln ,  toannotate, true, 1);
			System.out.println(result);
		}
