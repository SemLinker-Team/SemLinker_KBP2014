...
public class LinkQueries {
	 ...
	 */
	public LinkQueries(AnnotationInterface annotations, 
	 ...
	 * @return
	 */
	private void decideLink(AnnotationInterface annotations , String QnameNormalized, String Qname,  int linkAtPos, Logging log, int maxnumberofannotation){
