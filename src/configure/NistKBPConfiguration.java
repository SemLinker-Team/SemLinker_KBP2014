...
public class NistKBPConfiguration {
     ...
     * @see kbp2014.index.IndexSourceCorpus
     */
    public String INDEX;
    /**
     * This is the full path to the LUCENE Index file of a Wikipedia XML dump.
     * @see kbp2014.index.IndexWikipediaCorpus
     *
    */
    ...
    public String PATH_TO_TRAIN_DOC_LIST;
    //test
    public String PATH_TO_TEST_OUTPUT;
    public String PATH_TO_TEST_MERGED_OUTPUT;
    public String PATH_TO_TEST_MULTIPLE_OUTPUT;
    public String PATH_TO_TEST_CLUSTERED_OUTPUT;
    public String PATH_TO_TEST_CLUSTERED_MERGED;
    ...
    private void initVars() {
        ...
        else{ PATH_TO_CORRESPONDENCE_TABLE = RESOURCE_DIR + "kbp2014/wikimeta_table/WikimetaTable.txt"; }
        ...
        // doc list extraction
        if (CONFIG_MAP.containsKey("PATH_TO_TRAIN_DOC_LIST")) {
        	PATH_TO_TRAIN_DOC_LIST = TEST_DIR + CONFIG_MAP.get("PATH_TO_TRAIN_DOC_LIST");
        }
        else{ PATH_TO_TRAIN_DOC_LIST = TEST_DIR + "doc_list.txt"; } 
        
        if(CONFIG_MAP.containsKey("PATH_TO_TEST_MERGED_OUTPUT")){
        	PATH_TO_TEST_MERGED_OUTPUT = TEST_DIR + CONFIG_MAP.get("PATH_TO_TEST_MERGED_OUTPUT");
        }
        else{PATH_TO_TEST_MERGED_OUTPUT = TEST_DIR + "tac_2014_kbp_english_EDL_merge_queries_evaluation-result.tab";}
        // test 2013
        // output of the intermediary file
        ...
        if(CONFIG_MAP.containsKey("PATH_TO_TEST_CLUSTERED_MERGED")){
        	PATH_TO_TEST_CLUSTERED_MERGED = TEST_DIR + CONFIG_MAP.get("PATH_TO_TEST_CLUSTERED_MERGED");
        }
        else{PATH_TO_TEST_CLUSTERED_MERGED = TEST_DIR + "tac_2014_kbp_english_EDL_merge_queries_evaluation-result-k.tab";}
